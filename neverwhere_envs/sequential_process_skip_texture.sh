...
for SCENE_NAME in "${SCENE_NAMES[@]}"; do
    ...
    OPENMVS_DIR=$SCENE_DIR/mesh_openmvs
    ...
    python neverwhere_envs/process_collision.py -i $OPENMVS_DIR/model_dense_mesh_refine.ply -o $SCENE_DIR/openmvs_meshes/collision.obj
