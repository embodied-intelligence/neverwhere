...
from neverwhere.schemas import Scene, Urdf, Movable, PointLight, AmbientLight, Obj

pi = 3.1415

app = neverwhere(static_root="assets/mini_cheetah")

@app.spawn(start=True)
async def main(app: neverwhereSession):
