...
"""
# doc @ """https://neverwhere.ai/?ws=ws://localhost:8012&position=-0.33,0.75,0.68&rotation=1.31,-3.92,0.44&fov=50"""
with doc:
...
<iframe src="https://neverwhere.ai/?collapseMenu=True&fov=50&grid=False&scene={scene}" width="100%" height="400" frameborder="0"></iframe>

Or click on this <a href="https://neverwhere.ai/?collapseMenu=True&grid=False&fov=50&scene={scene}">link</a> to visit the scene in full screen.
...
Or click on this <a href="https://neverwhere.ai/?collapseMenu=True&fov=50&grid=False&scene={scene}">link</a> to visit the scene in full screen.
