...
def main(_deps=None, **deps):
    ...
    env = lucidsim.make(Unroll.env_name, device=Unroll.device, random=Unroll.seed, initial_state=initial_state)
...
if __name__ == "__main__":
    from neverwhere_baselines import instr

    thunk = instr(main)

    thunk(
        env_name="Real-heightmap-chase-real_flat_01_stata_grass",
